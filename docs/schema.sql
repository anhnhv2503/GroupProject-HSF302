...
CREATE TABLE order_items (
    ...
    CONSTRAINT chk_orderitem_type   CHECK ((combo_id IS NULL AND product_id IS NOT NULL) OR (combo_id IS NOT NULL AND product_id IS NULL))
);
...
CREATE TABLE order_status_history (
    ...
    CONSTRAINT chk_history_status CHECK (status IN ('PENDING','CONFIRMED','PROCESSING','SHIPPED','DELIVERED','CANCELLED'))
);
...
VALUES (
    'admin',
    'admin@oceanic.com',
    '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQyCgCmH.2jvZ7bRRyHkgHXni',
    'Oceanic Admin',
    'ADMIN',
    1
);
...
VALUES
    (N'Cá tươi',       N'Các loại cá tươi sống nhập mỗi ngày'),
...
VALUES
    (N'Combo Lẩu Hải Sản 4 người', N'Bao gồm tôm, mực, cá tươi chế biến sẵn cho lẩu', 499.00, 50, 1),
